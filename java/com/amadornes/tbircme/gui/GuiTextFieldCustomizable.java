...
public class GuiTextFieldCustomizable extends Gui {
		...
		if (tooltip != null && tooltip.trim().length() > 0)
			if (mx >= xPosition && mx < xPosition + width && my >= yPosition
				...
				RenderHelper.drawHoveringText(
						field_146211_a.listFormattedStringToWidth(this.tooltip, 150), mx, my,
						field_146211_a);
	}
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			...
			int i1 = this.enableBackgroundDrawing ? this.yPosition + (this.height - 8) / 2
					: this.yPosition;
			int j1 = l;
			...
			if (flag1) {
				if (flag2) {
					Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + this.field_146211_a.FONT_HEIGHT,
							-3092272);
				} else {
	 ...
	 */
	private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_,
			int p_146188_4_) {
		int i1;
	...
	public void setSelectionPos(int p_146199_1_) {
		...
		if (this.field_146211_a != null) {
			...
			if (p_146199_1_ == this.lineScrollOffset) {
				this.lineScrollOffset -= this.field_146211_a.trimStringToWidth(this.text, k, true)
						.length();
			}
