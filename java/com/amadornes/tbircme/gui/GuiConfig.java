...
public class GuiConfig extends GuiScreen {
	...
	public GuiConfig(boolean mainMenu) {
	...
	public void initGui() {
		...
		btn1.displayString = I18n.format(ModInfo.MODID + ".config.client.title");
		btn2.displayString = I18n.format(ModInfo.MODID + ".config.server.title");
	...
	public void drawScreen(int mx, int my, float frame) {
		...
		GL11.glPopMatrix();
		this.drawCenteredString(this.fontRendererObj,
				I18n.format(ModInfo.MODID + ".config.title", new Object[0]), this.width / 2, 67,
				16777215);
